...
- 波动板拆节点（正反向共用 B10/B11）：正向 `N14→B10→C7`、`C8→B11→C4`；反向 `C7→B10→N14`、`C4→B11→C8`；进板边 `BLBL`、出板边 `NONE`，C7/C4/N14/C8 恢复视觉检测+路口播报（不再越过路口提前转弯）
  ...
  - 待现场实测（反向新增）：`C7→B10` step=45、`B10→N14` step=10、`C4→B11` step=30、`B11→C8` step=20（进/出板边均 SPEED1）
  - 待现场实测（正向沿用）：`B10→C7` step=40、`B11→C4` step=20、`N14→B10` step=100、`C8→B11` step=30
...
- 2026-08-21：波动板拆节点（正反向共用 B10/B11）：进板 BLBL 出板 NONE，C7/C4/N14/C8 恢复路口检测+播报（修复未到路口提前转弯）
